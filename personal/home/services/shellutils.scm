(define-module (personal home services shellutils)
  #:use-module (gnu services configuration)
  #:use-module (personal home utils)
  #:use-module (gnu home services)
  #:use-module (personal home services base)
  #:use-module (personal home services shells)
